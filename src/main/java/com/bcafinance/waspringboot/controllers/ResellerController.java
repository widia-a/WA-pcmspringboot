...
import com.bcafinance.waspringboot.services.ResellerService;
...
public class ResellerController {
    ...
    public ResponseEntity<Object> updateResellerById(@Valid @RequestBody Resellers resellers) throws Exception{
    ...
    public ResponseEntity<Object> updateResellerByIDV2(@Valid @RequestBody Resellers resellers)throws Exception{
