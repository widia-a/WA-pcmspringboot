...
import com.bcafinance.waspringboot.models.Resellers;
import com.bcafinance.waspringboot.repos.ResellerRepo;
...
public class ResellerService {
    ...
    public Resellers findByResellerId(long resId) throws Exception {
        return resellerRepo.findById(resId).orElseThrow(() -> new ResourceNotFoundException(ConstantMessage.WARNING_NOT_FOUND));
    }
    ...
    public void updateResellerById(Resellers r) throws Exception {
        Resellers resellers = resellerRepo.findById(r.getResId()).orElseThrow(() -> new ResourceNotFoundException(ConstantMessage.WARNING_CUSTOMER_NOT_FOUND));
